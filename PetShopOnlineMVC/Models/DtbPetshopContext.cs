...
public partial class DtbPetshopContext : DbContext
{
    public DtbPetshopContext()
    {
    }

    public DtbPetshopContext(DbContextOptions<DtbPetshopContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<PictureProduct1> PictureProducts1 { get; set; }

    public virtual DbSet<Product> Products { get; set; }

    public virtual DbSet<ReasonCancel> ReasonCancels { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            ...
            entity.HasOne(d => d.Shipper).WithMany(p => p.Accounts)
        ...
        modelBuilder.Entity<PictureGallery>(entity =>
        {
            ...
            entity.HasOne(d => d.IdNavigation).WithMany(p => p.PictureGalleries)
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.HasMany(d => d.Pictures).WithMany(p => p.Products)
                .UsingEntity<Dictionary<string, object>>(
                    "PictureProduct",
                    r => r.HasOne<PictureProduct1>().WithMany()
                        .HasForeignKey("PictureId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_Picture_Products_PictureProducts"),
                    l => l.HasOne<Product>().WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_Picture_Products_Products"),
                    j =>
                    {
        ...
        modelBuilder.Entity<ReasonCancel>(entity =>
        {
            ...
            entity.HasOne(d => d.Order).WithMany(p => p.ReasonCancels)
                .HasForeignKey(d => d.OrderId)
